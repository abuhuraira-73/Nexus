...
export const SubscriptionPane = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-blue-500/20 text-blue-300 p-4 rounded-lg mb-6 max-w-full md:max-w-md break-words">
            ...
            <div className="space-y-4 max-w-full md:max-w-md p-6 rounded-lg bg-white/5 break-words">
