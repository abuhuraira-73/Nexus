                        ...
                        {features.map((feature, i) => (
                          <Card key={i} className="group bg-gray-900/50 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-2xl border-none">
                            <CardHeader>
                              ...
                              <CardTitle className="font-metropolis-bold">{feature.title}</CardTitle>
                            </CardHeader>
                            <CardContent>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-semibold mb-2 font-metropolis-bold">Sign Up</h3>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-semibold mb-2 font-metropolis-bold">Create a Canvas</h3>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="text-2xl font-semibold mb-2 font-metropolis-bold">Invite & Collaborate</h3>
                  ...
                  <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                      <Card className="bg-gray-900/50 backdrop-blur-sm transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                        <CardHeader>
                          <CardTitle className="font-metropolis-bold">Free</CardTitle>
                      ...
                      <Card className="border-purple-500 ring-2 ring-purple-500 bg-purple-500/10 backdrop-blur-sm transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                        <CardHeader>
                          <CardTitle className="font-metropolis-bold">Premium</CardTitle>
